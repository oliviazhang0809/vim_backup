...
alias vupp="vagrant up --provision --provider=openstack"
alias vs="vagrant status"
alias vsh="vagrant ssh"
alias ppl="puppet-lint --fix"

# Provider associated
alias epv="export PROVIDER=v"
alias epo="export PROVIDER=o"

### Added by the Heroku Toolbelt
export PATH="/usr/local/heroku/bin:$PATH"


export OS_AUTH_URL=https://os-identity.vip.slc.ebayc3.com:5443/v2.0
export OS_TENANT_ID=d298aa857521465abf5333fe5f6d4e2e
